import ctaReusableDefaults from "@/lib/data/cta-reusable.json";
...
export const DEFAULT_CTA_REUSABLE_SECTION: CtaReusableSectionData =
  ctaReusableDefaults as CtaReusableSectionData;
...
export function ctaReusableSectionToPayload(
  data: CtaReusableSectionData
