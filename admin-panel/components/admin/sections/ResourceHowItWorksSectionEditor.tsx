...
import {
  normalizeResourceHowItWorksSectionData,
  resourceHowItWorksSectionToPayload,
...
export default function ResourceHowItWorksSectionEditor({
  initialData,
  isActive,
  onIsActiveChange,
  onSave,
}: Props) {
  const [form, setForm] = useState<ResourceHowItWorksSectionData>(() =>
    normalizeResourceHowItWorksSectionData(initialData)
  );
  ...
  async function handleSave() {
    ...
    setError("");
    try {
      await onSave(resourceHowItWorksSectionToPayload(form), isActive);
    } catch (err) {
