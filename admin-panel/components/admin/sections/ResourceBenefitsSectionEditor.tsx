...
import {
  normalizeResourceBenefitsSectionData,
  resourceBenefitsSectionToPayload,
...
export default function ResourceBenefitsSectionEditor({
  initialData,
  isActive,
  onIsActiveChange,
  onSave,
}: Props) {
  const [form, setForm] = useState<ResourceBenefitsSectionData>(() =>
    normalizeResourceBenefitsSectionData(initialData)
  );
  ...
  async function handleSave() {
    ...
    setError("");
    try {
      await onSave(resourceBenefitsSectionToPayload(form), isActive);
    } catch (err) {
