...
export function mergeHeroSectionToolsData(
  cmsData: HeroSectionToolsData | null
): HeroSectionToolsData {
  if (!cmsData) return DEFAULT_HERO_SECTION_TOOLS;
  return normalizeHeroSectionToolsData(cmsData);
}

export function heroSectionToolsImageSrc(section: HeroSectionToolsData): string {
