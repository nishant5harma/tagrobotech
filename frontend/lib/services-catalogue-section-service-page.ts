...
export function mergeServicesCatalogueSectionServicePageData(
  cmsData: ServicesCatalogueSectionServicePageData | null
): ServicesCatalogueSectionServicePageData {
  if (!cmsData) return DEFAULT_SERVICES_CATALOGUE_SECTION_SERVICE_PAGE;
  return normalizeServicesCatalogueSectionServicePageData(cmsData);
}

export function servicesCatalogueImageSrc(item: ServicesCatalogueServiceItem): string {
