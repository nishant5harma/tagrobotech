...
import {
  heroSectionToolsImageSrc,
  mergeHeroSectionToolsData,
  type HeroSectionToolsData,
} from "@/lib/hero-section-tools";

type HeroSectionToolsProps = {
  data?: HeroSectionToolsData | null;
};
...
export default function HeroSectionTools({ data }: HeroSectionToolsProps) {
  const section = mergeHeroSectionToolsData(data ?? null);
  const imageSrc = heroSectionToolsImageSrc(section);
