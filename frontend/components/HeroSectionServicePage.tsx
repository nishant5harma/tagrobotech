...
import {
  heroSectionServicePageImageSrc,
  mergeHeroSectionServicePageData,
  type HeroSectionServicePageData,
} from "@/lib/hero-section-service-page";

type HeroSectionServicePageProps = {
  data?: HeroSectionServicePageData | null;
};
...
export default function HeroSectionServicePage({ data }: HeroSectionServicePageProps) {
  const section = mergeHeroSectionServicePageData(data ?? null);
  const imageSrc = heroSectionServicePageImageSrc(section);
