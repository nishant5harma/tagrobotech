...
export default function PageHeroSection({ data, context }: PageHeroSectionProps) {
  const section = mergePageHeroSectionData(data, context);
  const desktopSrc = pageHeroImageSrc(section.desktop_image_src, section.desktop_image_url);
  const mobileSrc = pageHeroImageSrc(section.mobile_image_src, section.mobile_image_url);
