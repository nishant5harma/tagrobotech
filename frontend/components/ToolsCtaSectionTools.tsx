...
import {
  mergeToolsCtaSectionToolsData,
  type ToolsCtaSectionToolsData,
} from "@/lib/tools-cta-section-tools";

type ToolsCtaSectionToolsProps = {
  data?: ToolsCtaSectionToolsData | null;
};
...
export default function ToolsCtaSectionTools({
  data,
}: ToolsCtaSectionToolsProps) {
  const section = mergeToolsCtaSectionToolsData(data ?? null);
